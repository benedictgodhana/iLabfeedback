...
#showConfirmPasswordBtn:hover #showConfirmPasswordIcon {
    color: #333;
}
...
<script>
    // Automatically hide the error alert after 3 seconds (adjust the duration as needed)
    setTimeout(function() {
...
@endif
    ...
    <div class="input-field">
        ...
        <button type="button" id="showPasswordBtn" onclick="togglePasswordVisibility()">
            <i id="showPasswordIcon" class="far fa-eye"></i>
        </button>
    </div>
    @error('password')
        <div class="alert error">{{ $message }}</div>
    ...
    @if(session('status'))
        ...
        <script>
            // Automatically hide the success alert after 3 seconds (adjust the duration as needed)
            setTimeout(function() {
...
<!-- ... -->
      ...
      <div class="panels-container">
        ...
        <p>
        Kindly complete the form to reset your password.
        </p>
